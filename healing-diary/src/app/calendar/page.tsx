...
import CalendarSkeleton from "@/loading/calendar/calendar-skeleton";
...
export default function CalendarPage() {
  ...
  return (
    <main className="flex w-full max-w-limit flex-1 flex-col items-stretch justify-start bg-white">
      {mounted ? <DiaryCalendar /> : <CalendarSkeleton />}
        ...
        <div className="flex w-full flex-col">
          <div className="pointer-events-none flex w-full flex-row items-center justify-between px-4 py-4">
            <div className="flex flex-col items-start gap-1">
              <p className="w-full text-xl font-semibold">2024.05.15 🧐</p>
              <p className="w-full text-xs text-gray-500">여기에서 내가 작성한 일기를 들어보세요</p>
            </div>
          </div>
